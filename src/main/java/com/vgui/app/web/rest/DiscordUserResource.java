...
import com.vgui.app.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link com.vgui.app.domain.DiscordUser}.
 */
@RestController
@RequestMapping("/api")
public class DiscordUserResource {
    ...
    public ResponseEntity<List<DiscordUser>> getAllDiscordUsers(DiscordUserCriteria criteria) {
        log.debug("REST request to get DiscordUsers by criteria: {}", criteria);
        List<DiscordUser> entityList = discordUserQueryService.findByCriteria(criteria);
